...
namespace FusionExamples.Tanknarok
{
	...
	public class Player : NetworkBehaviour, ICanTakeDamage
	{
		...
		public Vector3 velocity => _rb.Rigidbody.velocity;
		...
		public override void Spawned()
		{
			...
			GetComponent<NetworkRigidbody>().InterpolationDataSource = InterpolationDataSources.Auto;
		}
		...
		private bool IsGrounded(Vector3 position) {
			return Physics.OverlapSphere(position, collider.radius * 0.5f,
				LayerMask.GetMask("Field"), QueryTriggerInteraction.Ignore).Length > 0;
		}
		*/
